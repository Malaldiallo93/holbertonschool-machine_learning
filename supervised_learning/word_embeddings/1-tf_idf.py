...
def tf_idf(sentences, vocab=None):
    ...
    :param vocab: List of vocabulary words to use
    for the analysis (default: None)
    :return: embeddings, features
             - embeddings: numpy.ndarray of shape (s, f)
             containing the embeddings
               where s is the number of sentences and f
    ...
    # Fit the vectorizer to the sentences and transform
